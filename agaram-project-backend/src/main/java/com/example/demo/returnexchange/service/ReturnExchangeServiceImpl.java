...
//        try {
//            logger.info("Updating progress - ID: " + returnExchangeId + ", Status: " + status + ", Updated by: " + updatedBy);
//            
//            // Get the return/exchange details
//            Map<String, Object> returnExchange = repository.findReturnExchangeById(returnExchangeId);
//            if (returnExchange == null) {
...
//            validateStatusTransition(currentStatus, status.toUpperCase());
//            
//            // Update the status
//            int updated = repository.updateReturnExchangeStatus(
//                returnExchangeId, 
...
//                    ? message 
//                    : getDefaultCustomerMessage(status, type, orderId);
//                
//                repository.insertReturnExchangeNotification(
//                    returnExchangeId, 
//                    updatedBy, 
...
//                notifyNextTeamMember(returnExchangeId, status.toUpperCase(), orderId, type, customerUsername);
//                
...
//        }
//        
//        // Define valid transitions based on your workflow
//        switch (currentStatus.toUpperCase()) {
//            case "APPROVED":
//                if (!newStatus.equals("PICKED_UP")) {
//                    throw new IllegalArgumentException("From APPROVED, only COURIER can update to PICKED_UP");
//                }
//                break;
//            case "PICKED_UP":
//                if (!newStatus.equals("IN_TRANSIT_TO_WAREHOUSE")) {
//                    throw new IllegalArgumentException("From PICKED_UP, only AGENT can update to IN_TRANSIT_TO_WAREHOUSE");
//                }
//                break;
//            case "IN_TRANSIT_TO_WAREHOUSE":
//                if (!newStatus.equals("RECEIVED_AT_WAREHOUSE")) {
//                    throw new IllegalArgumentException("From IN_TRANSIT_TO_WAREHOUSE, only DISTRIBUTOR can update to RECEIVED_AT_WAREHOUSE");
//                }
//                break;
//            case "RECEIVED_AT_WAREHOUSE":
//                if (!newStatus.equals("QUALITY_CHECK_PASSED") && !newStatus.equals("QUALITY_CHECK_FAILED")) {
//                    throw new IllegalArgumentException("From RECEIVED_AT_WAREHOUSE, only WAREHOUSE can update to QUALITY_CHECK_PASSED or QUALITY_CHECK_FAILED");
//                }
//                break;
//            case "QUALITY_CHECK_PASSED":
//                if (!newStatus.equals("COMPLETED")) {
//                    throw new IllegalArgumentException("From QUALITY_CHECK_PASSED, only WAREHOUSE can update to COMPLETED");
//                }
//                break;
//            default:
//                if (currentStatus.equals("REJECTED") || currentStatus.equals("COMPLETED")) {
...
//        switch (status) {
//            case "PICKED_UP":
//                // After COURIER picks up, notify AGENT
...
//                    "Please update status to 'IN TRANSIT TO WAREHOUSE' when you begin transport.";
//                break;
//                
//            case "IN_TRANSIT_TO_WAREHOUSE":
//                // After AGENT marks in transit, notify DISTRIBUTOR
//                teamMessage = "DISTRIBUTOR ACTION REQUIRED: Item for " + type.toLowerCase() + " request #" + 
//                    returnExchangeId + " (Order #" + orderId + " from customer " + customerUsername + 
//                    ") is in transit to warehouse. " +
//                    "Please update status to 'RECEIVED AT WAREHOUSE' once the item arrives.";
//                break;
//                
//            case "RECEIVED_AT_WAREHOUSE":
//                // After DISTRIBUTOR confirms receipt, notify WAREHOUSE
...
//                
//            case "QUALITY_CHECK_PASSED":
//                // After quality check passes, WAREHOUSE should complete
...
//                // If quality check fails, notify customer
...
//        }
//        
//        // Normalize status strings (trim and uppercase)
//        String normalizedCurrent = currentStatus.trim().toUpperCase();
//        String normalizedNew = newStatus.trim().toUpperCase();
//        
//        logger.info("Validating transition from '" + normalizedCurrent + "' to '" + normalizedNew + "'");
//        
//        // Define valid transitions based on your workflow
//        switch (normalizedCurrent) {
//            case "APPROVED":
//                if (!normalizedNew.equals("PICKED_UP")) {
//                    throw new IllegalArgumentException("From APPROVED, only COURIER can update to PICKED_UP");
//                }
//                break;
//            case "PICKED_UP":
//                if (!normalizedNew.equals("IN_TRANSIT_TO_WAREHOUSE")) {
//                    throw new IllegalArgumentException("From PICKED_UP, only AGENT can update to IN_TRANSIT_TO_WAREHOUSE");
//                }
//                break;
//            case "IN_TRANSIT_TO_WAREHOUSE":
//                if (!normalizedNew.equals("RECEIVED_AT_WAREHOUSE")) {
//                    throw new IllegalArgumentException("From IN_TRANSIT_TO_WAREHOUSE, only DISTRIBUTOR can update to RECEIVED_AT_WAREHOUSE");
//                }
//                break;
//            case "RECEIVED_AT_WAREHOUSE":
//                if (!normalizedNew.equals("QUALITY_CHECK_PASSED") && !normalizedNew.equals("QUALITY_CHECK_FAILED")) {
//                    logger.severe("Invalid transition attempt from RECEIVED_AT_WAREHOUSE to " + normalizedNew);
//                    throw new IllegalArgumentException("From RECEIVED_AT_WAREHOUSE, only WAREHOUSE can update to QUALITY_CHECK_PASSED or QUALITY_CHECK_FAILED");
//                }
//                logger.info("Valid warehouse transition to " + normalizedNew);
//                break;
//            case "QUALITY_CHECK_PASSED":
//                if (!normalizedNew.equals("COMPLETED")) {
//                    throw new IllegalArgumentException("From QUALITY_CHECK_PASSED, only WAREHOUSE can update to COMPLETED");
//                }
//                break;
//            case "QUALITY_CHECK_FAILED":
//                // Allow re-assignment or cancellation
//                if (!normalizedNew.equals("CANCELLED") && !normalizedNew.equals("PENDING")) {
//                    throw new IllegalArgumentException("From QUALITY_CHECK_FAILED, can only update to CANCELLED or back to PENDING");
//                }
//                break;
//            case "REJECTED":
//            case "COMPLETED":
//            case "CANCELLED":
//                throw new IllegalArgumentException("Cannot update a " + normalizedCurrent + " request");
//            default:
//                throw new IllegalArgumentException("Invalid current status: " + normalizedCurrent);
//        }
//        
//        logger.info("Status transition validation passed");
//    }
    @Override
    @Transactional
    public int updateReturnExchangeProgress(int returnExchangeId, String status, String updatedBy, String message) {
