...
//           <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end',position: "sticky", top: 60, zIndex: 50, mb:2  }}>
//             <Button
//               variant="contained"
//               startIcon={<AssignmentReturnIcon />}
//               onClick={() => handleOpenReturnExchange('RETURN')}
...
//               value={searchQuery}
//               onChange={handleSearch}
//               sx={{     "& fieldset": { border: "none" } ,mb: 3, backgroundColor: "#f2f5fcf3", borderRadius: 10 }}
//             />
                    ...
                    <Box sx={{ p: 2 }}>
                      ...
                      >
                        {steps.map((label, idx) => {
                          ...
                          return (
                            <Step key={label}>
                              <Tooltip title={tooltipMessage} arrow placement={isMobile ? "right" : "top"}>
                                <StepLabel>
