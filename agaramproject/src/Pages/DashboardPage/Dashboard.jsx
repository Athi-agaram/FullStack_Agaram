...
//                     Total Revenue
//                   </Typography>
//                   <Typography variant="body2" sx={{ fontWeight: 'bold', color: "#092d52ff", mb: 0.5 }}>
//                     Company: ₹{summary.companyRevenue?.toLocaleString()}
//                   </Typography>
//                   {user.role !== "ADMIN" && (
//                     <Typography variant="body2" sx={{ color: "#092d52ff", fontWeight: '500' }}>
//                       Team: ₹{summary.teamRevenue?.toLocaleString()}
//                     </Typography>
//                   )}
//                 </CardContent>
...
//                 }}>
//                   <CardContent>
//                     <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Top Team</Typography>
//                     <Typography variant="h6" sx={{ fontWeight: 'bold', color: "#092d52ff" }}>{summary.topTeam}</Typography>
//                   </CardContent>
//                 </Card>
//               </Grid>
//             )}
...
//                 }}>
//                   <CardContent>
//                     <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Total Employees</Typography>
//                     <Typography variant="h6" sx={{ fontWeight: 'bold', color: "#092d52ff" }}>{users.length}</Typography>
//                   </CardContent>
//                 </Card>
//               </Grid>
//             )}
...
//                 }}>
//                   <CardContent>
//                     <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Top Customer</Typography>
//                     <Typography variant="h6" sx={{ fontWeight: 'bold', color: "#092d52ff" }}>{summary.topCustomer}</Typography>
//                   </CardContent>
//                 </Card>
//               </Grid>
...
//               }}>
//                 <CardContent>
//                   <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Total Sales</Typography>
//                   <Typography variant="h6" sx={{ fontWeight: 'bold', color: "#092d52ff" }}>{summary.teamSales}</Typography>
//                 </CardContent>
//               </Card>
//             </Grid>
...
//                 }}>
//                   <CardContent>
//                     <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Top Product</Typography>
//                     <Typography variant="h6" sx={{ fontWeight: 'bold', color: "#092d52ff" }}>{summary.topProduct}</Typography>
//                   </CardContent>
//                 </Card>
//               </Grid>
...
//                 }}>
//                   <CardContent>
//                     <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Team Members</Typography>
//                     <Typography variant="h6" sx={{ fontWeight: 'bold', color: "#092d52ff" }}>{summary.totalPeople}</Typography>
//                   </CardContent>
//                 </Card>
//               </Grid>
...
//               }}>
//                 <CardContent>
//                   <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: 'bold', mb: 1 }}>Growth Rate</Typography>
//                   <Typography variant="h6" sx={{ 
//                     color: summary.growthRate > 0 ? "green" : summary.growthRate < 0 ? "red" : "black", 
//                     fontWeight: 'bold' 
//                   }}>
//                     {summary.growthRate?.toFixed(2)}%
//                   </Typography>
...
//                 boxShadow: 2
//               }}>
//                 <Typography variant="subtitle1" sx={{ mb: 1, fontWeight: 'bold' }}>Monthly Revenue Trend</Typography>
...
//                 boxShadow: 2
//               }}>
//                 <Typography variant="subtitle1" sx={{ mb: 1, fontWeight: 'bold' }}>Product Progress</Typography>
//                 <ResponsiveContainer width="100%" height="88%">
//                   <PieChart>
//                     <Pie 
//                       data={progressData} 
...
//                   {user.role === "ADMIN" ? "Employee Role Distribution" : "Customer Distribution"}
//                 </Typography>
//                 <ResponsiveContainer width="100%" height="85%">
//                   <BarChart data={user.role === "ADMIN" ? roleData : customerData}>
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis 
//                       dataKey={user.role === "ADMIN" ? "role" : "customer"} 
//                       style={{ fontSize: '12px' }}
//                     />
//                     <YAxis style={{ fontSize: '12px' }} />
//                     <ReTooltip />
...
//                       dataKey={user.role === "ADMIN" ? "count" : "value"}
//                       fill={user.role === "ADMIN" ? "#82ca9d" : "#ff7f50"}
//                       barSize={window.innerWidth < 600 ? 30 : 40}
//                     />
//                   </BarChart>
//                 </ResponsiveContainer>
//               </Card>
